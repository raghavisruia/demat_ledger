...
import { DematImportColumnMap } from "@/types/DematLedger"

type Mapping = Pick<DematImportColumnMap, "index" | "maps_to" | "header_text" | "variable">

const toMapping = (columns?: DematImportColumnMap[]): Mapping[] =>
    (columns ?? []).map((c) => ({
        index: c.index,
        maps_to: c.maps_to,
